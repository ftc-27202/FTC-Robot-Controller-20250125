...
//        public double perpXTicks = 0.0; // x position of the perpendicular encoder (in tick units)
        public double parYTicks = -1342.1673324699425; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -878.5662762413566; // x position of the perpendicular encoder (in tick units)
    }
...
//        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "perp")));
        ...
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rightRear")));
